        ...
        <Box p={6} rounded="md" w="100%">
          <form onSubmit={formik.handleSubmit}>
            <VStack spacing={4}>
              ...
              <FormControl name="email" isInvalid={formik.touched.email && formik.errors.email}>
              ...
              <FormControl name="comment" isInvalid={formik.touched.comment && formik.errors.comment}>
